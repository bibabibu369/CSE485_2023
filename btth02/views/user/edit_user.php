...
<body>
    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                <h3 class="text-center text-uppercase fw-bold">Chỉnh sửa người dùng</h3>
                <?php if (isset($user) && !empty($user)): ?>
                <form action="index.php?controller=user&action=update&id=<?php echo htmlspecialchars($user->getId()); ?>" method="post">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblUserName">Tên người dùng</span>
                        <input type="text" class="form-control" name="username" readonly value="<?php echo htmlspecialchars($user->getUsername()); ?>" required>
                    </div>
                    <div class="input-group mt-3 mb-3">
