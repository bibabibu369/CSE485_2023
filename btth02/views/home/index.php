...
<body>
    <header>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item"><img src="assets/images/slideshow/slide03.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <main class="container-fluid mt-3">
        ...
        <div class="row">
                ...
                <div class="card mb-2" style="width: 100%;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-center">
                            <a href="views/home/detail.php" class="text-decoration-none">Cây, lá và gió</a>
                        </h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;"></div><img src="assets/images/songs/noitinhyeubatdau.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
