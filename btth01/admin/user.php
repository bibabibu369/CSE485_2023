                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><a href='edit_user.php?id=" . $row['ma_user'] . "'><i class='fa-solid fa-pen-to-square'></i></a></td>";
                                echo "<td><a href='del_user.php?id=" . $row['ma_user'] . "' onclick='return confirm(\"Bạn có chắc chắn muốn xóa người dùng này?\");'><i class='fa-solid fa-trash'></i></a></td>";
                                echo "</tr>";
                            }
                        } else {
