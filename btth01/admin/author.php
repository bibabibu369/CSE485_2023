                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_author.php?id=<?php echo $row['ma_tgia']; ?>" class="btn btn-warning btn-sm">Sửa</a>
                                <a href="?delete_id=<?php echo $row['ma_tgia']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa tác giả này?');">Xóa</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
